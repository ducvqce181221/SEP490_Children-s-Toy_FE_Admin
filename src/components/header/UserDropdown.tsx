...
export default function UserDropdown() {
  ...
  const { account, clearAuth } = useAuthContext();
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="mr-3 overflow-hidden rounded-full h-11 w-11 flex items-center justify-center text-white text-sm font-bold flex-shrink-0"
      ...
      >
        ...
        <button
          ...
          className="flex items-center gap-3 px-3 py-2 mt-3 font-medium text-red-500 rounded-lg group text-theme-sm hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors w-full text-left"
        >
          <svg
